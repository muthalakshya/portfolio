    ...
    >
      ...
      <div className="max-w-6xl mx-auto p-4 sm:p-8 mt-12 sm:mt-16 bg-white text-black rounded-lg border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] sm:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] sm:hover:shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] transition-all">
        ...
        <div className="flex text-blue-600 mt-2 items-center">
          <FaRegBuilding />
          <button onClick={() => window.open("https://ideaforage.com", "_blank")} className="font-medium ml-2 text-base sm:text-lg">
        ...
        <ul className="mt-4 list-disc pl-6 marker:text-black text-sm sm:text-base">
          ...
          <li>Developed a MERN-based e-commerce platform for Toynik (toynik.com) as a solo developer.</li>
          <li>Implemented JWT-based authentication, PhonePe payment gateway, and Delhivery API for logistics.</li>
          <li>Created a separate admin panel for managing products, orders, users, and delivery workflows.</li>
      ...
      <div className="max-w-6xl mx-auto p-4 sm:p-8 mt-12 sm:mt-16 bg-white text-black rounded-lg border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] sm:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] sm:hover:shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] transition-all">
        ...
        <div className="flex text-blue-600 mt-2 items-center">
          <FaRegBuilding />
          <button onClick={() => window.open("https://entrepi.world", "_blank")} className="font-medium ml-2 text-base sm:text-lg">EntrePi</button>
        </div>
        <ul className="mt-4 list-disc pl-6 marker:text-black text-sm sm:text-base">
          <li>
          ...
          <li>Built student, teacher, and public-facing applications, including landing pages and role-based dashboards.</li>
          <li>Implemented AI-assisted question and assessment generation mapped to CBSE curriculum and syllabus.</li>
          <li>Integrated automation workflows using n8n for content and question generation.</li>
          <li>Developed and deployed platforms such as SourPickle (tournament tracker), Stocks & Ladder (learning game for NSE stocks), and Geeta (microlearning app).</li>
          <li>Worked on end-to-end development, deployment, and iteration of multiple production domains.</li>
        </ul>
      </div>
      ...
      <div className="max-w-6xl mx-auto p-4 sm:p-8 mt-12 sm:mt-16 bg-white text-black rounded-lg border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] sm:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] sm:hover:shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] transition-all">
        ...
        <div className="flex text-blue-600 mt-2 items-center flex-wrap">
          <FaRegBuilding />
          <button
            onClick={() => window.open("http://vlab.iitr.ac.in/index.html", "_blank")}
